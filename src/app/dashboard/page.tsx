      ...
      <section className="mb-6">
        ...
        {docs.length === 0 ? (
          <div className="rounded-lg border border-neutral-800 bg-neutral-900 p-5 text-sm text-neutral-400">
            Nothing yet. Drop a file above (or use{" "}
            <code className="rounded bg-black/40 px-1.5 py-0.5 text-indigo-300">docs_upload</code>{" "}
            from your MCP client) to get started.
          </div>
        ) : (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    {d.errorMsg && (
                      <div className="mt-2 text-xs text-red-400">{d.errorMsg}</div>
                    )}
                  </div>
                </div>
              </div>
